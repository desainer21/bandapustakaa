...
if(action==='delete'){
   ...
   const removed=await fetch(`${url}/rest/v1/orders?id=eq.${encodeURIComponent(orderId)}`,{method:'DELETE',headers});
   if(!removed.ok)throw new Error('Gagal menghapus transaksi.');return json(200,{deleted:true});
  }
